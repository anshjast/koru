...
class _TrainScreenState extends State<TrainScreen> {
  ...
  Widget build(BuildContext context) {
    const trainGradient = [Colors.teal, Colors.cyan];
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Flexible(child: _buildEmoji(1, '😞')),
                          Flexible(child: _buildEmoji(2, '😐')),
                          Flexible(child: _buildEmoji(3, '🙂')),
                          Flexible(child: _buildEmoji(4, '😊')),
                          Flexible(child: _buildEmoji(5, '🤩')),
                        ],
                      ),
                      const SizedBox(height: 20),
                      GradientButton(
